...
$con = mysqli_connect('localhost','root','','project');
    ...
    $sql= mysqli_query($con,"select * from electriccar");
    ...
    for(;$result=mysqli_fetch_array($sql);)
    {
        ...
        array_push($CarID,$result['Car_ID']);
        array_push($engine,$result['Battery']);
        array_push($mileage,$result['Mileage']);
        array_push($fueltype,$result['Chargetime']);
...
<html lang="en" dir="ltr">
   <head>
      <meta charset="utf-8">
      <title>Booking Electic car</title>
...
<div class="head">
  <h1>ELECTRIC CARS</h1>
      ...
      if($i==0) {
        ...
        echo  '<div class="text">
        <img src=data:image;base64,'.base64_encode($image[$i]).'>
            </div>
